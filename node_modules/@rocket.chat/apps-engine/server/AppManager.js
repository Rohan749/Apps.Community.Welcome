...
class AppManager {
    ...
    add(appPackage, installationParameters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.bridges.getAppActivationBridge().doAppAdded(app).catch(() => {
    ...
    update(appPackage, permissionsGranted, updateOptions = { loadApp: true }) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const aff = new compiler_1.AppFabricationFulfillment();
            const result = yield this.getParser().unpackageApp(appPackage);
            ...
            const descriptor = {
                ...
                id: result.info.id,
                info: result.info,
                status: ((_a = this.apps.get(old.id)) === null || _a === void 0 ? void 0 : _a.getStatus()) || old.status,
                languageContent: result.languageContent,
            ...
            if (updateOptions.loadApp) {
                ...
                yield this.bridges.getAppActivationBridge().doAppUpdated(app).catch(() => { });
            }
            return aff;
        });
    }
    ...
    loadOne(appId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const item = yield this.appMetadataStorage.retrieveOne(appId);
            const appPackage = yield this.appSourceStorage.fetch(item);
            const unpackageResult = yield this.getParser().unpackageApp(appPackage);
            if (!item) {
